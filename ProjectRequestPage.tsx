...
const ProjectRequestPage: React.FC = () => {
  ...
  const submitRequest = async () => {
    try {
      ...
      if (response.ok) {
        alert(`Request submitted! Payment of $${calculatedFee.toLocaleString()} processed.`);
  ...
  return (
    <div className="p-8">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="mb-4">
          <label className="block mb-2">Contractor Company</label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label className="block mb-2">Property Owner Name</label>
          <input
            type="text"
            className="w-full border rounded px-3 py-2"
        ...
        <div className="mb-4">
          <label className="block mb-2">Property Owner Phone</label>
          <input
            type="tel"
            className="w-full border rounded px-3 py-2"
        ...
        <div className="mb-4">
          <label className="block mb-2">Service Level</label>
          <select
            className="w-full border rounded px-3 py-2"
        ...
        {showPayment && (
          <div className="mt-4 p-4 bg-green-50 rounded">
            ...
            >
              Pay ${calculatedFee.toLocaleString()} & Submit Request
            </button>
          </div>
        )}
      </div>
